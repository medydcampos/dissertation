...
lm_model <- lm(
  early_pregnancy_rt_transformed ~ dummy_enrollments_high_school_full + gdp_pc + failures_high_school + dropouts_high_school + approvals_high_school + HDI_index_FIRJAN,
...
lm_model_adjusted <- lm(
  early_pregnancy_rt_transformed ~ dummy_enrollments_high_school_full + gdp_pc + failures_high_school + dropouts_high_school + HDI_index_FIRJAN,
  data = municipalities_filtered
)
...
gee_beta_model_2 <- geeglm(
  early_pregnancy_rt_transformed ~ dummy_enrollments_final_yers_full + gdp_pc + failures_high_school + dropouts_high_school + HDI_index_FIRJAN,
  id = municipality, family = gaussian, data = municipalities_filtered
)
